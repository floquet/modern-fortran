...
module mMatrices
    ...
    type                         :: matrices  ! use intrinsic matrix tools to form solution
...
!                     print *, 'construct_matrices_sub: lecho = ', lecho, 'echo = ', echo
!                   allocations
...
!                   construct inverse
                    call ints % compute_intermediates_dot ( measure )
