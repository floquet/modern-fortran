...
! dan-topas-pro-2:gulf bevington rditldmt$ date
! Tue Dec  1 13:18:59 CST 2015
! dan-topas-pro-2:gulf bevington rditldmt$ pwd
! /Users/rditldmt/Box Sync/fortran/projects/least squares/gulf bevington
! dan-topas-pro-2:gulf bevington rditldmt$ gfortran  -Wall -Wextra -Wconversion -Og -pedantic -fcheck=bounds -fbacktrace -g  -fmax-errors=5 lsq.f08
! myModules/mod intermediates.f08:133:17:
!
!              if ( me % det == zero ) then
!                  1
! Warning: Equality comparison for REAL(8) at (1)
! dan-topas-pro-2:gulf bevington rditldmt$ ./a.out
!
! System identifiers...
...
! time for contructing matrices = 0.125E-03s
!  normal_a_sub: fecho =  T echo =  T
!
! Successful allocation of 9 real ( rp ) elements:
! size = 9 elements, sizeof = 72 bytes
...
!
! constructing matrices...
! time for contructing matrices = 0.380E-04s
!
...
!
! CPU time for all tasks =  0.406E-03 seconds
!
! STOP successful completion for program lsq.
! dan-topas-pro-2:gulf bevington rditldmt$