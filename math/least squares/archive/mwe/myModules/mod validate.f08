...
!       ===========================================================================================  load_bevington_measurements_6_1
        ...
        subroutine validate_bevington_6_1_sub ( me )
            ...
            !type ( measurements ) :: measures
                ...
                validate % soln_linear ( 2 ) % descriptor_64 = 'normal equations, summation'
                call validate % soln_linear ( 3 ) % normal_a ( validate % measurement, echo = .true. )
                return
!                 call validate % soln_linear ( 2 ) % normal_a ( ints % compute_intermediates_dot ( validate % measurement ), &
!                                                            validate % measurement, echo = .true. )

                validate % soln_linear ( 3 ) % descriptor_64 = 'normal equations, dot product'
!                call validate % soln_linear ( 3 ) % normal_a ( validate % measurement, echo = .true. )
                call validate % soln_linear ( 3 ) % normal_a ( validate % measurement, echo = .true. )

                validate % numSolnsLinear = 3
