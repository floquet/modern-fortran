...
module mValidate
    ...
    type ( intermediates )             :: myInts
        ...
        contains
            ...
            procedure, public :: validate_bevington_I_a         => validate_bevington_I_a_sub
            procedure, public :: validate_bevington_I_b         => validate_bevington_I_b_sub
    ...
    private :: validate_bevington_I_a_sub
    private :: validate_bevington_I_b_sub
...
!       ===========================================================================================             compare_solutions_sub
        ...
        subroutine compare_solutions_sub ( me )
            ...
            class ( comparison ), target :: me
                ...
                write ( * , 800 ) me % computed % cpu_seconds_compute, 'normal equations solution'
                write ( * , 800 ) me % computed % cpu_seconds_allocate, 'memory allocation'
...
!       ===========================================================================================     load_bevington_measurements_I_a

        subroutine validate_bevington_I_a_sub ( me )

            class ( comparison ), target :: me

                me % bevington_fiducial % descriptor_64 = 'Bevington exercise 6-1, p 93'
                call me % load_bevington_I ( )
                call me % computed % normal_a ( echo = .true., who = 'a' )
                !normal_a_sub ( me, echo, compute, ints )
                !call me % computed % normal_a ( echo = .true., compute = compute_intermediates_a, ints = myInts )
                call me % compare_solutions ( )

        end subroutine validate_bevington_I_a_sub

!       ===========================================================================================     load_bevington_measurements_I_b  

        subroutine validate_bevington_I_b_sub ( me )

            class ( comparison ), target :: me

                me % bevington_fiducial % descriptor_64 = 'Bevington exercise 6-1, p 93'
                call me % load_bevington_I ( )
                call me % computed % normal_a ( echo = .true., who = 'b' )
                call me % compare_solutions ( )

        end subroutine validate_bevington_I_b_sub
...
!       ===========================================================================================      load_bevington_measurements_II
        ...
        subroutine validate_bevington_II_sub ( me )
            ...
            class ( comparison ), target :: me
                ...
                call me % computed % normal_a ( echo = .true., who = 'c' )
                call me % compare_solutions ( )
