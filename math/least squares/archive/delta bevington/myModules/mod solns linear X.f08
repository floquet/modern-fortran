...
!       =============================================================================================                       normal_a
        ...
        subroutine normal_a_sub ( me, echo, compute, ints )
            ...
            interface methodIntermediates
                subroutine compute ( me, ints )
                    class ( solution_linear ), target      :: me
                    type ( intermediates ), intent ( out ) :: ints
                end subroutine compute
            end interface methodIntermediates
