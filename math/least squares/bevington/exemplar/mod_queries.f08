...
module mQueries
    ...
    integer ( ip )                     :: numArgsInput = 0
    integer ( ip )                     :: c_arg_lipt ( 1 : numArgsMax ) = 0

    character ( len =  512 ) :: myHost           = ''
    character ( len = 1024 ) :: compilerVersion  = ''
    character ( len = 1024 ) :: compilerOptions  = ''  ! Cray options overran 512 characters
    character ( len = 1024 ) :: executionCommand = ''
    ...
    contains                                                                                    ! methods: subroutines and functions
        ...
        subroutine qLib_ping_system ( )
            ...
            character ( len = 512 )          :: cmd = '', host = ''
                ...
                write ( compilerVersion,  '( "compiler version  = ", g0 )' ) trim ( c_version )
