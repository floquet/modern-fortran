...
! Sun Mar 20 13:58:08 CDT 2016
! Muntz-Szasz:fsu dantopa$ pwd
! /Users/dantopa/Box Sync/fortran/demos/MPI/mpi examples/fsu
! Muntz-Szasz:fsu dantopa$ mpif90 -Wall -Wextra -Wconversion -Og -pedantic -fcheck=bounds -fmax-errors=5 hello.f90
...
!
!   Elapsed wall clock time =   0.702270E-04 seconds.
!
