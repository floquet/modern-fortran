...
program pi_constant_precision
    ...
    integer,     parameter :: ip = INT64, dp = INT32, rp = REAL64 ! control precision in one place
    real ( rp ), parameter :: M_PI = acos ( -1.0_rp ), zero = 0.0_rp, one = 1.0_rp

    integer ( ip ) :: k0 = 0_ip, j = 0_ip, k = 0_ip
    integer ( ip ) :: numInt = 0_ip, numProc = 0_ip, numSlicePP = 0_ip 
    integer ( dp ) :: host_status = 0_dp, io_out = 0_dp, ierr = 0_dp, rank = 0_ip
