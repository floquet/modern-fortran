program pi_omp
    ...
    integer ( ip ) :: N = 1024 * 1024 * 1024  !! Number of intervals
    integer ( ip ) :: w = 0, i = 0
    ...
    real ( rp ) :: pi_computed = 0.0_rp, mypi = 0.0_rp
        ...
        N = 1024_rp * 1024_rp * 1024_rp * 1024_rp
        sum = 0.0_rp
        call cpu_time ( t0 )
        ...
        call cpu_time ( t1 )
        write ( *, 100 ) num_threads, N, N / 1024 / 1024 
        !write ( *, 110 ) pi_computed, 'pi computed'
        !write ( *, 110 ) pi_actual, 'pi actual'
        !write ( *, 110 ) pi_actual - pi_computed, 'error'
        write ( *, 120 ) t1 - t0, pi_actual - pi_computed

    100 format ( /, 'Results using ', g0, ' threads over ', g0, ' intervals (', g0,' M intervals):' )
    !110 format ( g0, 2X, g0 )
    120 format ( g0, ', ', g0, ' ( CPU time, error )' )
