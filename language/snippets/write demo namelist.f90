...
!     ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    BEGIN MAIN
      ...
      open  ( nml_unit, file = 'demo.nml', delim = 'apostrophe', &
                        iostat = io_status )      
      if ( io_status .ne. 0 ) then                             ! can't open file
        write ( *,  * ) ''
      ...
      write ( unit = nml_unit, nml = nlist, iostat = io_status )
      if ( io_status .ne. 0 ) then                            ! can't write file
        write ( *,  * ) ''
...
!subroutine get_namelist ( namelist )
