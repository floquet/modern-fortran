...
program move_selector
    ...
    real :: y = 1.0
        ...
        call local_selector ( double, x , y )
...
! Thu Oct  8 13:59:29 CDT 2015
! dan-topas-pro-2:echo rditldmt$ pwd
! /Users/rditldmt/Box Sync/fortran/demos/passing subroutines/echo
! dan-topas-pro-2:echo rditldmt$ gfortran  -Wall -Wextra -Wconversion -Og -pedantic -fcheck=bounds -fmax-errors=5 b\ move_selector.f08 -o move_selector
