...
program lapack_demo_svd
    ...
    ! parameters
    real ( rp ), parameter           :: s_mm ( 1 : 4 ) = [ 9.996627661356914_rp,  3.683101373968635_rp, &
                                                           1.3569287262747172_rp, 0.5000440991298909_rp ]
    character ( len = * ), parameter :: myProgram = "lapack_demo_svd", myFile = "dgesvd-ex.d"
    ...
    integer                          :: INFO = 0, LWKOPT = 0!, k = 0
        ...
        id = matmul ( Ap, myA )
        call print_matrix ( id, 'F8.3', 1, moniker = 'Identity matrix Ap A' )
