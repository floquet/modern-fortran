...
! Wed Jan 20 14:17:52 CST 2016
! dan-topas-pro-2:nla rditldmt$ pwd
! /Users/rditldmt/Box Sync/fortran/demos/nla
! dan-topas-pro-2:nla rditldmt$ gfortran  -Wall -Wextra -Wconversion -Og -pedantic -fcheck=bounds -fmax-errors=5 -framework Accelerate eigenvalues.f08
! eigenvalues.f08:6:8:
!
!      use precision_definitions, only : wp, ip, unit_modulus, one, zero
!         1
...
!
! input matrix:
! ( 1.0000000000000000 + .0000000000000000 i )  ( .0000000000000000 + 2.0000000000000000 i )  ( 3.0000000000000000 + .0000000000000000 i )
! ( -.0000000000000000 + -2.0000000000000000 i )  ( 5.0000000000000000 + .0000000000000000 i )  ( 1.0000000000000000 + -1.0000000000000000 i )
! ( 3.0000000000000000 + .0000000000000000 i )  ( 1.0000000000000000 + 1.0000000000000000 i )  ( 7.0000000000000000 + .0000000000000000 i )
!
