module mComponents
    ...
    character ( len = 3 )            :: who
    character ( len = * ), parameter :: myDir = '$wdmersenne', exec = 'cpu_measure'
...
contains
    ...
    120 format ( '' )
    130 format ( 'cd ', g0 )
    140 format ( './', g0, ' -d > timing_results.out' )
    ...
    subroutine local_txt_cpu_lynx ( machine, proc, nJobs )
        integer,               intent ( in ) :: nJobs
        character ( len = * ), intent ( in ) :: machine, proc
    ...
    end subroutine local_txt_cpu_lynx

    ! +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +  +

    subroutine local_txt_cpu_leo ( machine, proc, nJobs )
        integer,               intent ( in ) :: nJobs
        character ( len = * ), intent ( in ) :: machine, proc
    ...
    end subroutine local_txt_cpu_leo
