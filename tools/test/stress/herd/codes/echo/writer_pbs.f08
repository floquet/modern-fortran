program writer_pbs
    use mComponents, only : pbs_script, launcher_script, spreader_script, local_txt_cpu_lightning, prime_txt
    ...
    character ( len = * ), parameter :: cores    = 'select=1:ncpus=24:mpiprocs=24'
