module mTestSuite
    ...
    ! parameters
<<<<<<< HEAD
    integer, parameter :: measurements = 20
=======
...
<<<<<<< HEAD
            write ( io_handle, 110 ) trim ( hpc ), trim ( rack ), rank, 'matmul', 'cpu',         [ ( stats ( k ), k = 1, 5 ) ]

            stats = averager ( array_wall )
            write ( io_handle, 110 ) trim ( hpc ), trim ( rack ), rank, 'matmul', 'wall',        [ ( stats ( k ), k = 1, 5 ) ]

            stats = averager ( array_util )
            write ( io_handle, 110 ) trim ( hpc ), trim ( rack ), rank, 'matmul', 'utilization', [ ( stats ( k ), k = 1, 5 ) ]
=======
