...
module mPopulations
    ...
    use mPhotons,               only : photons, photon0
    use mRandom,                only : random_distribution_annulus_sub, random_vector_of_points_sub, randomAnnularList, randomList
    ! use mUtilities
