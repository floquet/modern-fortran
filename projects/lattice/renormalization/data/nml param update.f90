!     open namelist
      ...
      if ( io_status /= 0 ) then                               ! can't open file
        ...
        write ( *,  * ) 'trying to write namelist run_param_update'
...
!     write namelist
      ...
      if ( io_status /= 0 ) then                              ! can't write file
        write ( *,  * )
        write ( *,  * ) 'unable to write file ', file_name_param_update
        write ( *,  * ) 'trying to write namelist run_param_update'
        write ( *,  * ) 'iostat  = ', io_status
        write ( *,  * ) 'io unit = ', io_unit_nml
      ...
      write ( *, * ) 'successful write to ', file_name_param_update

!     close file
      close ( unit = io_unit_nml, iostat = io_status )
      if ( io_status /= 0 ) then                              ! can't write file
        write ( *,  * )
        write ( *,  * ) 'unable to close file ', file_name_param_update
        write ( *,  * ) 'trying to write namelist run_param_update'
        write ( *,  * ) 'iostat  = ', io_status
        write ( *,  * ) 'io unit = ', io_unit_nml
