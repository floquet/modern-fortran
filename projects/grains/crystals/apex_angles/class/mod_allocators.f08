module mAllocations
    ...
    contains
        ...
        subroutine allocator_rank_1_sub ( array, rows )
        ...
        subroutine allocator_rank_1_ints_sub ( array, rows )

            integer ( ip ), allocatable, intent ( out ) :: array ( : )
            integer ( ip ),              intent ( in )  :: rows
        ...
        end subroutine allocator_rank_1_ints_sub
