...
!       ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++                          action
        ...
        function action_fcn ( self, rule ) result ( decision )

            class ( hands ), target       :: self

            integer ( is ), intent ( in ) :: rule
...
!       ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++                  play_this_hand
        ...
        subroutine play_this_hand_sub ( self, pID, rule, pSHoe, BustList, OpenList, nBust, nOpen )
            ...
            character ( len = * ), parameter :: me_subroutine = 'module play_this_hand_sub'  ! self-identification
