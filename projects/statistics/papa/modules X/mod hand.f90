...
module mHand
    ...
    type, public       :: hands
        ...
        contains
            ...
            procedure, public :: test_rules        =>  test_rules_sub
...
!       ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++                  set_best_value
        ...
        subroutine set_best_value_sub ( self )
            ...
            integer ( is )                   :: v ! hand value
                ...
                self % values ( 1 ) = v
                self % best_value   = v
!                 write ( *, '( "nCardsHand = ", g0 )' ) self % nCardsHand
!                 write ( *, '( "numAces = ", g0 )' ) self % numAces
!                 write ( *, '( "best value = ", g0 )' ) v
!                 write ( *, '( "cards = ", g0 )' ) ( self % cards ( kHand ), kHand = 1, self % nCardsHand )
...
!                     do hHand = 1, nofPip
!                         allChoices = playerRules ( jHand ) % handValue ( kHand )
!                         decision = allChoices ( hHand : hHand )
!                         write ( *, 110 ) kHand, pDescriptors ( hHand : hHand ), decision
!                     end do
                end do
                write ( *, * )
                !pntRules => null ( )
